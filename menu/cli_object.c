...
/*   Updated: 2024/07/30 17:52:12 by adiaz-uf         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	cli_sp(t_object *o)
{
	...
	o->obj.sp.center.z, rint(o->material.k_d.r * 255.0f), rint(o->material.k_d.g * 255.0f),
	rint(o->material.k_d.b * 255.0f), o->material.k_d.a);
}
