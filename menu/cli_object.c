...
/*   Updated: 2024/07/31 18:37:43 by adiaz-uf         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	cli_cy(t_object *o)
{
	printf(BHYEL"CYLINDER "BHMAG
		...
		BHRED"0. Exit\n"BHWHT"1. Position\n"BHGRN"2. Radius\n"BHBLU
		"3. Material\n"BHBLK"4. Ambient\n"BHYEL"5. Height\n"BHMAG"6. Normal\n\n"
		END, sqrt(o->obj.cy.r2), o->obj.cy.center.x, o->obj.cy.center.y,
		o->obj.cy.center.z, rint(o->material.k_d.r * 255.0f),
		rint(o->material.k_d.g * 255.0f), rint(o->material.k_d.b * 255.0f),
		o->obj.cy.h, o->obj.cy.normal.x, o->obj.cy.normal.y,
		o->obj.cy.normal.z);
}
...
{
	(void)o;
	printf(BHRED"Quadratic\nEnter '0' to exit:\n");
	printf(BHYEL"Enter '1' to change Quadratic function:\n");
	printf(BHBLU"Enter '2' to change material:\n"BHMAG);
}
